package com.example.michong_pc.tiku.function_activity.Sign;
...
public class Sign extends AppCompatActivity implements MyViewFlipper.OnViewFlipperListener {
...
//            "or displayed formula: $$\\sum_{i=0}^n i^2 = \\frac{(n^2+n)(2n+1)}{6}$$";
            ...
            sign.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(flag==0) {
                        ...
                        Toast.makeText(Sign.this,"标记题目",Toast.LENGTH_SHORT).show();
                        flag=1;
                    }else{
                        //取消标记题目
                        ((ImageButton) v).setImageDrawable(getResources().getDrawable(R.drawable.no_start));
                        Toast.makeText(Sign.this,"取消标记题目",Toast.LENGTH_SHORT).show();
                        flag=0;
                    }
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ID = sharedPreferences.getString("num"," ");
        chapter_url = "http://tk.e8net.cn/ApiLibrary/getStudentMark/stu_id/"+ID;

        Toolbar toolbar = (Toolbar) findViewById(R.id.id_tool_bar2);
        toolbar.setTitle("标记题目");
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sign.this, choose_question.class));
            }
        });
